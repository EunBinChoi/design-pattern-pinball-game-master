...
public class movingDoor : MonoBehaviour
{
    ...
    private doorState readySt = new readyState();
    private doorState passedSt = new passedState();
    private doorState movingSt = new movingState();
    private doorState closedSt = new closedState();
